...
export function renderTopbar({d,scene,deps}){
  const {hasClockModule,getClockEntries,getTimeDisplayText,getWeatherDisplayText,hasSimpleTimekeeping,moduleVersion}=deps;
...
export function bindSceneAdminEvents({el,scene,d,deps}){
  ...
  el.querySelector("#tb-board-manager")?.addEventListener("click",()=>openBoardActorMgr?.(scene,d));
